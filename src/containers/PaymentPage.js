      ...
      <Header />
        <div className=' p-[3rem] pt-[6rem]  '>
            <div className='flex flex-col lg:flex-row justify-around'>
                <form className='lg:w-[45%] w-[100%]  text-gray-500 text-start'>
                    ...
                    <div className='flex my-[.7rem]'>
                        ...
                        <label for='master' className='flex justify-between items-center  '>
                            ...
                            <p className='flex justify-between items-center ml-[7rem]'><img src={visaImage}  className='w-[4rem] h-[2.3rem] object-cover shadow-md shadow-gray-400'/><img src={masterImage} className='w-[4rem] h-[2.3rem] object-cover shadow-md shadow-gray-400 ml-[.7rem]' /> <img className='w-[4rem] h-[2.3rem] object-cover shadow-md shadow-gray-400 ml-[.7rem]' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPLG6FjxQLNUZ6Byo6Jxz3typNb9mlMQne0A&usqp=CAU' /></p>
                        </label>
                    </div>
                    <div className='flex mt-[.5rem]'>
                        ...
                        <label for='paypal' className='flex justify-between items-center  '>
                            ...
                            <p className='flex justify-between items-center ml-[9rem]'><img src={paypalImage}  className='w-[4rem] h-[2.3rem] object shadow-md shadow-gray-400'/></p>
                        </label>
                    </div>
